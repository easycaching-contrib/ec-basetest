...
public abstract class BaseDistributedLockTest
{
    private readonly string _name;
    private readonly IDistributedLockFactory _lockFactory;
    private readonly ITestOutputHelper _output;

    protected BaseDistributedLockTest(string name, IDistributedLockFactory lockFactory, ITestOutputHelper output)
    {
        _name = name;
